        ...
        class << self
          ...
          def generate_graph(options = {})
            ...
            RRD.graph("#{path_graph}#{graph_name}",
              ...
              draw_area :data => 'uin', :color => '#99ff99', :label => 'Total\t'
              ...
              draw_area :data => 'umout', :color => '#e50b00', :label => ''
              draw_line :data => 'umout', :color => '#7f0000', :label => ''
              draw_area :data => 'uout', :color => '#ffb199', :label => 'Committed\t'
              draw_line :data => 'uout', :color => '#800000', :label => ''
